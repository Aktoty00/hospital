# Generated by Django 2.2 on 2019-04-25 02:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home_test.Patient')),
            ],
        ),
        migrations.CreateModel(
            name='Bill',
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home_test.Patient')),
                ('treatment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home_test.Treatment')),
            ],
        ),
        migrations.CreateModel(
            name='Appoiment',
